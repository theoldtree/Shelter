...
const Page_21________________O____  = ({navigation}) => {
	useEffect(() => {
	}, []);
	return (
	<KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{height: Dimensions.get("window").height}}>
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<View style = {noneModeStyles._page36}    >
			...
			<View style = {noneModeStyles._Group_284}    >
			...
			<Text style = {noneModeStyles.________________________________}   >
				*단일 - 약병 또는 타블렛에 처방된 한 가지 종류의 약
			</Text>
		</View>
	</ScrollView>
	</KeyboardAvoidingView>
)}
export default Page_21________________O____
