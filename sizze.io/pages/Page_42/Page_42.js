...
const Page_42  = ({navigation}) => {
	useEffect(() => {
	}, []);
	return (
	<KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{height: Dimensions.get("window").height}}>
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<View style = {noneModeStyles._page42}    >
			...
			<View style = {noneModeStyles._1__Single_Line___C__small_text_icon_6}    >
...
_1__Single_Line___C__small_text_icon_6: {
	width: 328,
	height: 48,
	position: "absolute",
	left: 16,
